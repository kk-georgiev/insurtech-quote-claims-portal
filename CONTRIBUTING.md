...
- Ако PR-ът затваря story от `sprint-status.yaml` — статусът на тази story
  (и на epic-а, ако е последната) се сменя на `done` в **същия PR**, не в
  следваща задача или чак на следващото ретро. `sprint-status.yaml` не бива
  да изостава зад merged PR-ове — това изоставане се повтори в три
  последователни epic-а (Epic 5 retro item 40, Epic 6 item 47, Epic 8 item
  1) и всеки път е трябвало да се коригира ръчно при следващото ретро.
