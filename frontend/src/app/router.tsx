...
// content and Story 2.4 adds the role-guard wrapper. `HealthStatus` (the
// Story 1.1 backend round-trip) moves off `index` to `/health`.
//
...
export const routes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: 'liquidator', element: <LiquidatorShell /> },
      { path: 'administrator', element: <AdministratorShell /> },
